<template>
  <Layout class="layout" theme="light">
    <div
      :style="{ width: `${asiderWidth}px`, 'flex': `0 0 ${asiderWidth}px`, 'max-width': `${asiderWidth}px`, 'min-width': `${asiderWidth}px` }"
      class="sider-background">
    </div>
    <Layout.Sider collapsedWidth="56" v-model:collapsed="collapsed" :width="asiderWidth" :trigger="null" collapsible
      class="layout-sider">
      <Logo :collapsed="collapsed" />
      <AsideMenu :collapsed="collapsed" />
      <a-button size="large" type="text" class="menu-fold" @click="() => collapsed = !collapsed">
