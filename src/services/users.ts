...
export class UsersService {
  ...
  static login(data) {
    ...
    console.log(data)
    return Promise.resolve(<any>{"token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOjEsInB2IjoxLCJpYXQiOjE2NTQ2MTE2MTB9.Iw_nCKLGiStpPsZ3m_L9u1pIi7qD2-cMBNwUc_UXo3I"})
  }
  static info(){
